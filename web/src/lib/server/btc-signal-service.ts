...
function toPublicExecutionStatus(execution: PersistedSignalExecution | null): BtcSignalExecution | null {
  ...
  return {
    ...
    restingClientOrderId: execution.restingClientOrderId,
    restingPriceDollars: execution.restingPriceDollars,
    makerPlacedAt: execution.makerPlacedAt,
    makerCanceledAt: execution.makerCanceledAt,
    makerFilledContracts: execution.makerFilledContracts,
    fallbackStartedAt: execution.fallbackStartedAt,
